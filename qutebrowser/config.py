...
config.bind(",d", "spawn --detach wezterm start yt-dlp {url}")
config.bind(",D", "hint links spawn --detach wezterm start yt-dlp {hint-url}")
config.bind(",M", "hint links spawn --detach qbittorrent {hint-url}")
...
c.statusbar.widgets = ["keypress", "search_match", "scroll_raw", "tabs", "progress"]
